export const en = {
  ...
  dashboard: {
    ...
    updated: 'Updated',
    popularPositions: 'Top 5 Positions by CVs',
    trendingTags: 'Trending Technology Tags',
    candidateHint: 'These positions match your profile. Click Apply to create a CV.',
    availablePositions: 'Available Positions',
    action: 'Action',
    apply: 'Apply',
    yourCVs: 'Your CVs',
    recruiterHint: 'Manage your positions and view applicants.',
